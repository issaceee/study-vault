...
12pm thursday - essay due

1. past texts
2. 2. past texts + beowulf
3. texts in W3 + beowulf - Heroism


COmmentary vs Essay
- commentary functions as purely close reading

Essay

* quote old english, translation in bracket
	* if not own translation – footnote and explain why use that given translation
* quote with the line divisions (/ for half line,, // for line break)
	* helps to draw attention to how meanings can shift over (half-)lines
	* helps to train attention to the fact that this is formal poetry

- DOE for everything before certain letter
- Bosworth for everyth after certain letter
==> utilise the corpus/usage figures to see outward references 

- look at handbook/faculty guide for citation instructions
	- Author Date in-text citation
	- footnote citation

google scholar
- date range - to see if theres more up to date scholarship

==international medieval bibliography (SOLO)==


- cambridge companion to (medieval mysticism etc. etc.)
	- broad survery of themes that critics are directed towards
	- good bibliographies


time seems to be the enemy in the poem\
- time seems to eat away at the poem (the poet skips out certain parts) - 50 years before Dragon
	- the grit of enduring human seems to be unable to made into a narrative
- BUT towards the end the poem seems to choke on the narrators, how Beowulf becomes 
- during the fight of the dragon, Beowulf remembers being fostered out as a child
	- idea that you can cleanly separate out moments of conflict, victory, triumph andf the grit of human interaction and power --> becomes increasingly untenable --> becomes a very prosaic scene


monsters vs humans
- reflects the interest of a contemporary audience
- some of the people who are gestured towards, there seems to be a sense of narrative consciousness
	- the queen --> famous in the same way that Grendel is famous
	- cedmund
	- fin digression and the fin (?) episode
- audience at that point can map onto familliar narrative points (stories that are maybe already old at that point? but maybe also this is a hook in )
	- king of the yets (Beowulfs king) --> the first monster in the book Liber Monsterum (?) 
		- skeleton is so big that people come to visit (a mythic, historical figure --> a testament to the way stories morph and shift)
		- passes the hero-monster boundary in a new and interesting way

what bits gets told and repeated
- the fights with Grendel,, that Beowulf keeps on reiterating
	- seems to be the substance of his heroism
