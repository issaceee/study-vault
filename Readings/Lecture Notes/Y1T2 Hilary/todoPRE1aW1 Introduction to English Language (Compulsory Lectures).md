...
politics of choice
- form and paralanguage
- medium
- vocab & meaning
- grammar & syntax
- image & multimodality
	- anchorage
		- image and text alw work together,,, the text that anchors the image and orients meaning in certain ways (how are we led to read certain images in certain ways)
		- e.g newspaper images w/ headlines
			- assume a certain point of view - text producer, readership
			- **naming conventions (honorifics, markers of familiarity) --> hinting at power dynamics

** even when something doesnt have overt markers, something might be going on (trying to normalise/hide something)
