---
Paper: PRE1a
Lecturer: Prof Lynda Mugglestone
Date: 2026-01-22
---
...
Critical Discourse Analysis - unpick patterns of language use, patterns of constructing events in certain ways, how the same event can be constructed in different ways (constructivist approach)
- how can we make something appear different than how something is 

event/object can be semantizied (can be made to mean in different ways)
- convincing of the validity/"truth"/rightness of particular readings

** ramifications of idealogies (set of beliefs)

Teun van Dijk - Principles of Critical Discourse Analysis (1993)
- 249-83
	- everday forms of text andt alk that appear 'natura;' and quite 'acceptable'
		- "legitimate control, or otherwise naturalize the social order, and especially relations of intequality"

CDA technique can be used when:
- unpicking questions of power
- unpicking how events are shaped and constructed; and then reproduced
- highlighting operation of what can be seen as naturalised hierarchy/prejudice

use of language to undermine presuopossitions 



Strategies:
1. social actors: creating identity
2. Agency and action (transitivity model)
	- verbs, passives, actives, who does what, and how?
	- great of thinking about power, who is foregrounded and who is backgrounded; responsibility of blame transferred, denied hidden
3. epistemic modality: coding stance and affect, our attitudes to events etc, especially via expressions of certainty or doubt
	- coding of expressions of certainty or doubt into language
...
functionalization: when social actors are represented or defined in relation to what they do e.g. director, manager
- vs. opersonalization – which instead focusses on representation via pronouns, names, or individualised charactrer
