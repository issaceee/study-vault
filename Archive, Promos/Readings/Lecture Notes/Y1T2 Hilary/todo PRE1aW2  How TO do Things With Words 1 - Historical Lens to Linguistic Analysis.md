...
- finger/sigital; hand/manual; tooth/dental
	- Writers today are 'haunted by the notion that Latin or Greek words are grander than Saxon ones'
- scorpion grass (scorpion as french origin) vs forget-me-not (all 3 are anglo-saxon origin) vs latin 

- register and etymology can be in conflict
	- 'The dogs go on w/ their **doggy** life' (doggy instead of canine)
	- "The **liquefaction** of her clothes" (liquefaction instead of flowing like water)

- Recipe across the ages
	- OE
		- manuscript, prose
		- telgramattic style (super terse)
	- Middle English
		- less sparse, more full sentences
		- idea of cuisine is more emphasised --> french/france
			- greyn de parys
		- possessive þyn --> formal your and informal your
	- MdnE
		- short syntax --> clarity
		- imperatives
		- possessive pronouns
		- loan words/heightened diction --> function of cookbook is to teach something you don't know
		
		- 19thc - style is still oral, but tradition becomes more written (c.f Isabella Beeton, The Book of Jousehold Management)
			- housewives/mistress addressed instead of cooks
			- clause of sentence are linked by subordination (paratactic syntax)
			- polysyllabic 
			- high sociallete oral style
				- modus operandi, or mode
				- "getting ready" - middle class
				
			- very explicit, almost scientific register
			- telegraphies, cramped diction
			- "when liked underdone --> lack of subject"
			- semicolon, complexity of word order
		- Charles E Francatelli, A plain Cookery Book for the Working Classes
			- condescending/patronising addresses to the reader
		- ==> class & gender; commodification, authority

- smoking in tolkien
	- linguistic aesthetic: tobacco (implications of tobacco industy, colonialism) vs pipe-weed
	- Hornblower; Longbottom; SOuthfarthing --> compounding as a feature of germanic origin rather than suffixing/affixing
 
- Tolkien's The Fall of Arthur
	- gap between sound and spelling
	- Queen vs Cold/Cruel/King --> alliteration that works aurally but not visually --> english spelling not rly the same as pronunciation (OE of Queen starts with 'C')
	- conscious archaisms - "bewrayed"; french: "prowess", "anguish", "seige"
		- seige used as its older meaning (old french, seat)
		- seige glorious (noun preceeding adjective --> usual in old european language)
...
![[HT2 Texts and Time (1) 2026-1.pptx]]
